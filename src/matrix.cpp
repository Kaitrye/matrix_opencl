...
void Matrix::multiply_opencl(const Matrix& other) {
    ...
    cl::Buffer bufferA(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(int) * M * K, data_.data());
    cl::Buffer bufferB(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(int) * K * N, (void*)other.data());
    ...
    queue.enqueueReadBuffer(bufferC, CL_TRUE, 0, sizeof(int) * M * N, (void*)result.data());
